...
func (c *userServiceClient) DelUser(ctx context.Context, in *DelUserReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedUserServiceServer) DelUser(context.Context, *DelUserReq) (*emptypb.Empty, error) {
