...
type OrdersServiceClient interface {
	...
	DelOrder(ctx context.Context, in *DelOrderReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *ordersServiceClient) DelOrder(ctx context.Context, in *DelOrderReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type OrdersServiceServer interface {
	...
	DelOrder(context.Context, *DelOrderReq) (*emptypb.Empty, error)
...
func (UnimplementedOrdersServiceServer) DelOrder(context.Context, *DelOrderReq) (*emptypb.Empty, error) {
