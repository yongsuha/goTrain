...
type OrderTicketServiceClient interface {
	AddOrderTicket(ctx context.Context, in *AddOrderTicketReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	DelOrderTicket(ctx context.Context, in *DelOrderTicketReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *orderTicketServiceClient) AddOrderTicket(ctx context.Context, in *AddOrderTicketReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *orderTicketServiceClient) DelOrderTicket(ctx context.Context, in *DelOrderTicketReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type OrderTicketServiceServer interface {
	AddOrderTicket(context.Context, *AddOrderTicketReq) (*emptypb.Empty, error)
	DelOrderTicket(context.Context, *DelOrderTicketReq) (*emptypb.Empty, error)
...
func (UnimplementedOrderTicketServiceServer) AddOrderTicket(context.Context, *AddOrderTicketReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddOrderTicket not implemented")
}
func (UnimplementedOrderTicketServiceServer) DelOrderTicket(context.Context, *DelOrderTicketReq) (*emptypb.Empty, error) {
