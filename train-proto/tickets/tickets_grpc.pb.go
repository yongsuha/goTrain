...
type TicketServiceClient interface {
	...
	DelTicket(ctx context.Context, in *DelTicketReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *ticketServiceClient) DelTicket(ctx context.Context, in *DelTicketReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type TicketServiceServer interface {
	...
	DelTicket(context.Context, *DelTicketReq) (*emptypb.Empty, error)
...
func (UnimplementedTicketServiceServer) DelTicket(context.Context, *DelTicketReq) (*emptypb.Empty, error) {
