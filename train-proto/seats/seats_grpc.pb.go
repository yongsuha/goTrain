...
type SeatServiceClient interface {
	...
	DelSeat(ctx context.Context, in *DelSeatReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *seatServiceClient) DelSeat(ctx context.Context, in *DelSeatReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type SeatServiceServer interface {
	...
	DelSeat(context.Context, *DelSeatReq) (*emptypb.Empty, error)
...
func (UnimplementedSeatServiceServer) DelSeat(context.Context, *DelSeatReq) (*emptypb.Empty, error) {
