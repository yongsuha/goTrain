...
type TrainServiceClient interface {
	...
	Update(ctx context.Context, in *UpdateTrainReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	GetTrainDetail(ctx context.Context, in *GetTrainDetailReq, opts ...grpc.CallOption) (*GetTrainDetailResp, error)
	DelTrain(ctx context.Context, in *DelTrainReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *trainServiceClient) Update(ctx context.Context, in *UpdateTrainReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *trainServiceClient) DelTrain(ctx context.Context, in *DelTrainReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type TrainServiceServer interface {
	...
	Update(context.Context, *UpdateTrainReq) (*emptypb.Empty, error)
	GetTrainDetail(context.Context, *GetTrainDetailReq) (*GetTrainDetailResp, error)
	DelTrain(context.Context, *DelTrainReq) (*emptypb.Empty, error)
...
func (UnimplementedTrainServiceServer) Update(context.Context, *UpdateTrainReq) (*emptypb.Empty, error) {
...
func (UnimplementedTrainServiceServer) DelTrain(context.Context, *DelTrainReq) (*emptypb.Empty, error) {
