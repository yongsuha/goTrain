...
func (o *OrdersService) GetOrderDetail(ctx context.Context, req *ordersRpc.GetOrderDetailReq) (*ordersRpc.GetOrderDetailResp, error) {
	...
	order, err := o.ordersConfModel.GetOrderDetail(ctx, getOrderParam)
	if err != nil {
	...
	resp := &ordersRpc.GetOrderDetailResp{
...
func (o *OrdersService) DelOrder(ctx context.Context, req *ordersRpc.DelOrderReq) error {
	...
	if orderDetail == nil {
		return errors.New("orderDetail is empty")
	}
